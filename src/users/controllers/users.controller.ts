...
import { CreateUserPostDto } from 'src/dto/CreateUserPostDto';
...
export class UsersController {
    ...
    createUserPost(
        @Param('username') username:string, 
        @Body() creteUserPostDto:CreateUserPostDto){
            return this.userService.createUserPost(username,creteUserPostDto)
